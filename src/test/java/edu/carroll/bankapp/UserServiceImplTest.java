...
public class UserServiceImplTest {
        ...
        public void testCreateValidUser() {
                ...
                // Create a new user
                SiteUser newUser = userService.createUser(name, email, username, password).getResult();
        ...
        public void testUpdatePassword() {
                ...
                SiteUser unicodeMan = userService.createUser(UNICODE_NAME, UNICODE_EMAIL, UNICODE_USERNAME,
                                UNICODE_PASSWORD).getResult();
        ...
        public void testUpdatePasswordWithWeakNewPassword() {
                ...
                assertFalse(userService.updatePassword(user, UNICODE_PASSWORD, weakPassword).getResult(),
        ...
        public void testUpdatePasswordWithEmptyNewPassword() {
                ...
                assertFalse(userService.updatePassword(user, UNICODE_PASSWORD, emptyPassword).getResult(),
        ...
        public void testUpdatePasswordWithNullNewPassword() {
                ...
                assertFalse(userService.updatePassword(user, UNICODE_PASSWORD, null).getResult(),
        ...
        public void testUpdatePasswordWithNullUser() {
                ...
                assertFalse(userService.updatePassword(null, UNICODE_PASSWORD, newPassword).getResult(),
        ...
        public void testUpdateUsername() {
                ...
                assertTrue(userService.updateUsername(unicodeMan, UNICODE_PASSWORD, newUsername).getResult(),
        ...
        public void testUpdateShortUsername() {
                ...
                assertFalse(userService.updateUsername(jane, newPassword, newShortUsername).getResult(),
        ...
        public void testUpdateUsernameWrongPassword() {
                ...
                assertFalse(userService.updateUsername(jane, wrongPassword, newUsername).getResult(),
        ...
        public void testUpdateNullUsername() {
                ...
                assertFalse(userService.updateUsername(jane, newPassword, emptyUsername).getResult(),
                ...
                assertFalse(userService.updateUsername(jane, newPassword, nullUsername).getResult(),
        ...
        public void testUpdateUsernameWithExistingUsername() {
                ...
                assertFalse(userService.updateUsername(user, UNICODE_USERNAME, JOHN_USERNAME).getResult(),
